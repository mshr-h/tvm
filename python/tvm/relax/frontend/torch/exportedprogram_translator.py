...
class ExportedProgramImporter(BaseFXGraphImporter):
    ...
    def __init__(self):
        super().__init__()
        self.convert_map = self.create_convert_map()
    ...
    def create_input_vars(
        ...
        for spec in exported_program.graph_signature.input_specs:
            ...
            dtype = BaseFXGraphImporter._convert_data_type(torch_dtype)
    ...
    def create_convert_map(
        ...
        return {
            ...
            "leaky_relu.default": self._leakyrelu_functional,
            ...
            "conv_transpose1d.default": self._conv1d_transpose_functional,
            "conv_transpose2d.input": self._conv2d_transpose_functional,
            "conv1d.default": self._conv1d_functional,
            "conv2d.default": self._conv2d_functional,
            "conv3d.default": self._conv3d_functional,
            ...
            "max_pool2d.default": self._max_pool2d_functional,
            ...
            "upsample_nearest2d.vec": self._interpolate,
            # statistical
            "mean.dim": self._mean,
